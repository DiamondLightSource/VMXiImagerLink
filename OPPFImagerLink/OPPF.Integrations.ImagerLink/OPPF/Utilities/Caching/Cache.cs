...
namespace OPPF.Utilities.Caching
{
    ...
    /// <param name="e"></param>
    public delegate void CacheItemExpiredEventHandler(object sender, CacheItemExpiredEventArgs e);
    ...
    /// <param name="e"></param>
    /// <returns></returns>
    public delegate object FetchItemEventHandler(object sender, FetchItemEventArgs e);
    ...
    public class Cache
    {
        ...
        public object Fetch(string key, object param)
        {
            ...
            // FIXME This is bad practice because there can be more than one FetchItemEventHandler delegate invoked.
            // Probably should have an, eg, ICacheDataProvider interface, concrete class and assigned instance to use.
            // As it happens, I know there's only one delegate per cache in this package.
