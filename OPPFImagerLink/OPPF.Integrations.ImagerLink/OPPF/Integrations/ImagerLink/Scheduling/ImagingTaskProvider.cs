...
namespace OPPF.Integrations.ImagerLink.Scheduling
{
	...
	/// </remarks>
	public class ImagingTaskProvider : IImagingTaskProvider, IDisposable
	{
		...
		/// </summary>
		private static readonly string PLATEDB_CONNECTION_STRING = "driver={PostgreSQL Unicode};Server=changeMe.ac.uk;Database=changeMe;UID=changeMe;PWD=changeMe;";
		//private static readonly string PLATEDB_CONNECTION_STRING = "driver={PostgreSQL Unicode};Server=localhost;Database=changeMe;UID=changeMe;PWD=changeMe;";
		...
		public IImagingTask[] GetImagingTasksFromWebService(Formulatrix.Integrations.ImagerLink.IRobot robot, string plateID)
		{
			...
			if (null != response)
			{
                ...
                global::OPPF.Proxies.ImagingTask[] wrapper = response.wrapper;
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!this.disposed)
            {
                if (disposing)
                {
                    ...
                    if (null != _platedbConnection)
                    {
                        _platedbConnection.Close();
                        _platedbConnection.Dispose();
                        _platedbConnection = null;
                    }
                }
